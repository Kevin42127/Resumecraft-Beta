...
function ColorDebugPageContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">顏色除錯</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div><strong>字體:</strong> {formData.settings.fontFamily}</div>
              </div>
            </div>
          </div>
...
export default function ColorDebugPage() {
  return (
    <ResumeFormProvider>
      <ColorDebugPageContent />
    </ResumeFormProvider>
  )
} 