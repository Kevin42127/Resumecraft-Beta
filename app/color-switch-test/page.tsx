...
function ColorSwitchTestPageContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">顏色切換測試</h1>
...
export default function ColorSwitchTestPage() {
  return (
    <ResumeFormProvider>
      <ColorSwitchTestPageContent />
    </ResumeFormProvider>
  )
} 